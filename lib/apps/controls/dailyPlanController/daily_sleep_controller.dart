                                                              ...
                                                              Obx(
                                                                () =>
                                                                  ...
                                                                  alignment:
                                                                      Alignment
                                                                          .center,
                                                                  height: (listVariable[e]
                                                                              as RxBool)
                                                                          .value
                                                                      ? 45
                                                                      : 0,
                                                                  width: (listVariable[e]
                                                                              as RxBool)
                                                                          .value
                                                                      ? 45
                                                                      : 0,
                                        ...
                                        final r = await Get.dialog(YesNoDialog(
                                            press: () {
                                              ...
                                              listVariable
                                                ...
                                                if ((value as RxBool).value) {
                                                  dateSelect
                                                      .add(weekDayTonInt[key]);
                                                }
                                              });
                                              updateDataCollection({
                                                'id': element.id,
                                                'bedTime': choseTime.value,
                                                'alarm': (choseTime.value)
                                                    .add((choseDuration.value)),
                                                'isTurnOn': element.isTurnOn,
                                                'isTurnOn1': element.isTurnOn1,
                                                'listDate':
                                                    dateSelect.isNotEmpty
                                                        ? dateSelect
                                                        : [1, 2, 3, 4, 5, 6, 7],
                                              });
                                              initAll();
                                            ...
                                            question:
                                                'Do you want Update this schedule ?',
                                            title1:
